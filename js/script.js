...
function agregarTarea() {
    ...
    if (tareaTexto !== "") {
        ...
        hechoNoHechoDiv.classList.add('col-md-3', "col-sm-3");
        ...
        actividadDiv.classList.add('col-md-6', "col-sm-6", "tarea"); // Cambiado de 9 a 6
        ...
        botonEliminar.classList.add('col-md-3', "col-sm-3", "eliminar"); // Agregar clases de Bootstrap
